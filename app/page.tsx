      ...
      <main className="max-w-4xl mx-auto px-6 sm:px-8 lg:px-16">
            ...
            <div className="lg:col-span-2 flex flex-col justify-end space-y-6 sm:space-y-8 mt-8 lg:mt-0">
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {["Python", "C#", ".NET", "React", "SQL", "Azure"].map((skill) => (
                    <span
                      key={skill}
              ...
              {[
                {
                  ...
                  description:
                    "Deconstructed undocumented AMI.NET system, fixing billing logic flaws and safeguarding $1B+ in annual revenues. Integrated DevSecOps threat modeling and refactored React + TypeScript UI.",
                ...
                },
                {
                  ...
                  company: "NielsenIQ",
                  description:
                    "Developed .NET plugin for Microsoft Dynamics 365 automating data retrieval for 10,000+ users. Optimized Power Automate flows, cutting API calls by 35% and reducing cloud costs by $1.2K monthly.",
                ...
                },
                {
                  ...
                  company: "NielsenIQ",
                  description:
                    "Reduced 2,000 lines of code to 200 using Scala, boosting data processing efficiency by 30%. Monitored data pipelines with Apache Airflow and Azure Databricks.",
            ...
            <div className="grid gap-6 sm:gap-8 lg:grid-cols-2">
              {[
                ...
                },
                {
                  ...
                  excerpt:
                    "Deep learning model using VGG-19 to transform input audio into a target vocal style while preserving the original content.",
                  tech: ["Python", "VGG-19", "Deep Learning"],
                  links: { demo: "#", github: "#" },
                  image: "/images/audio-transfer.jpg",
                },
                {
                ...
                <article
                  key={index}
                  className="group relative overflow-hidden border border-border rounded-lg hover:border-muted-foreground/50 transition-all duration-500 hover:shadow-lg cursor-pointer"
                >
                  <div className="relative h-48 overflow-hidden bg-muted">
                    ...
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-background via-background/60 to-transparent opacity-90 group-hover:opacity-80 transition-opacity duration-500"></div>
                  </div>
                  ...
                  <div className="p-6 sm:p-8 space-y-4">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {project.tech.map((tech) => (
                        <span
                          key={tech}
                          className="px-2 py-1 text-xs border border-border rounded-full text-muted-foreground hover:border-muted-foreground/50 transition-colors duration-300"
                        >
                          {tech}
                        </span>
                      ))}
            ...
            <div className="space-y-6 sm:space-y-8">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="text-base sm:text-lg text-muted-foreground">403-681-1823</div>
                </div>
              </div>
            </div>
        ...
        <footer className="py-12 sm:py-16 border-t border-border">
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 sm:gap-8">
            <div className="space-y-2">
              <div className="text-sm text-muted-foreground">© 2025 Karanjot Singh. All rights reserved.</div>
            </div>
